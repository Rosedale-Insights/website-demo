				...
				<div>
					<label className="mb-1.5 block text-xs font-medium text-forge-secondary">
						...
						<textarea
							...
							rows={2}
							className="mt-1.5 w-full resize-none rounded-lg border border-forge-divider bg-white px-4 py-3 text-sm text-forge-primary outline-none transition-colors focus:border-forge-primary"
						/>
					</label>
				</div>
				<div>
					<label className="mb-1.5 block text-center text-xs font-medium text-forge-secondary">
						...
						<div className="relative">
							<select className="w-full appearance-none rounded-lg border border-forge-divider bg-white px-4 py-3 pr-10 text-sm text-forge-primary outline-none transition-colors focus:border-forge-primary">
								<option>{model}</option>
