	...
	return (
		<div className="glass-solid overflow-hidden rounded-lg">
			...
			<div className="grid grid-cols-[1fr_1.2fr_1.5fr_1fr_1fr_1fr_80px] items-center gap-4 border-b border-forge-divider bg-black/[0.02] px-6 py-3">
				...
				<span className="text-xs font-medium uppercase tracking-wider text-forge-hint">Supplier</span>
				<span className="text-xs font-medium uppercase tracking-wider text-forge-hint">Material</span>
				<span className="text-xs font-medium uppercase tracking-wider text-forge-hint">Promised</span>
				<span className="text-xs font-medium uppercase tracking-wider text-forge-hint">Predicted</span>
